...
ActiveRecord::Schema.define(version: 2021_04_06_200454) do
  ...
  create_table "joke_likes", force: :cascade do |t|
    t.bigint "joke_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["joke_id"], name: "index_joke_likes_on_joke_id"
    t.index ["user_id"], name: "index_joke_likes_on_user_id"
  end
  ...
  add_foreign_key "joke_likes", "jokes"
  add_foreign_key "joke_likes", "users"
